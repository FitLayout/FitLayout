...
/**
 * A default ContentRect implementation that is a tree node at the same time. This class is usually not used
 * directly; the {@link DefaultBox} and {@link DefaultArea} subclasses should be used instead. 
 * 
 * @author burgetr
 */
public class DefaultTreeContentRect<T extends GenericTreeNode<T>> extends DefaultTreeNode<T> implements ContentRect
{
    ...
    public boolean equals(Object obj)
    {
        ...
        DefaultTreeContentRect<T> other = (DefaultTreeContentRect<T>) obj;
