...
public class BoxNode extends DefaultTreeNode<org.fit.layout.model.Box> implements org.fit.layout.model.Box
{
     ...
     */
    @Override
    public org.fit.layout.model.Color getBackgroundColor()
    {
        if (getBox() instanceof ElementBox)
        {
            ...
            if (clr != null)
            {
                org.fit.layout.model.Color nclr = new org.fit.layout.model.Color(clr.getRed(), clr.getGreen(), clr.getBlue(), clr.getAlpha());
                return nclr;
            }
            else
                return null;
